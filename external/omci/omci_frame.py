...
from scapy.fields import ShortField, ConditionalField, MultipleTypeField
from scapy.packet import Packet

from external.omci.omci_fields import FixedLenField
from external.omci.omci_messages import OmciCreate, OmciDelete, \
...
from external.omci.omci_messages import OmciCreateResponse
...
class OmciFrame(Packet):
    ...
    fields_desc = [
        ...
        MultipleTypeField(
            [
                (
                    FixedLenField(PacketField("omci_message", None, OmciCreate), align=36),
                    lambda pkt: pkt.message_type == OmciCreate.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciCreateResponse), align=36),
                    lambda pkt: pkt.message_type == OmciCreateResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciDelete), align=36),
                    lambda pkt: pkt.message_type == OmciDelete.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciDeleteResponse), align=36),
                    lambda pkt: pkt.message_type == OmciDeleteResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciSet), align=36),
                    lambda pkt: pkt.message_type == OmciSet.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciSetResponse), align=36),
                    lambda pkt: pkt.message_type == OmciSetResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciGet), align=36),
                    lambda pkt: pkt.message_type == OmciGet.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciGetResponse), align=36),
                    lambda pkt: pkt.message_type == OmciGetResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciGetAllAlarms), align=36),
                    lambda pkt: pkt.message_type == OmciGetAllAlarms.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciGetAllAlarmsResponse), align=36),
                    lambda pkt: pkt.message_type == OmciGetAllAlarmsResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciGetAllAlarmsNext), align=36),
                    lambda pkt: pkt.message_type == OmciGetAllAlarmsNext.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciGetAllAlarmsNextResponse), align=36),
                    lambda pkt: pkt.message_type == OmciGetAllAlarmsNextResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciMibUpload), align=36),
                    lambda pkt: pkt.message_type == OmciMibUpload.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciMibUploadResponse), align=36),
                    lambda pkt: pkt.message_type == OmciMibUploadResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciMibUploadNext), align=36),
                    lambda pkt: pkt.message_type == OmciMibUploadNext.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciMibUploadNextResponse), align=36),
                    lambda pkt: pkt.message_type == OmciMibUploadNextResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciMibReset), align=36),
                    lambda pkt: pkt.message_type == OmciMibReset.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciMibResetResponse), align=36),
                    lambda pkt: pkt.message_type == OmciMibResetResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciAlarmNotification), align=36),
                    lambda pkt: pkt.message_type == OmciAlarmNotification.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciAttributeValueChange), align=36),
                    lambda pkt: pkt.message_type == OmciAttributeValueChange.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciReboot), align=36),
                    lambda pkt: pkt.message_type == OmciReboot.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciRebootResponse), align=36),
                    lambda pkt: pkt.message_type == OmciRebootResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciGetNext), align=36),
                    lambda pkt: pkt.message_type == OmciGetNext.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciGetNextResponse), align=36),
                    lambda pkt: pkt.message_type == OmciGetNextResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciSynchronizeTime), align=36),
                    lambda pkt: pkt.message_type == OmciSynchronizeTime.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciSynchronizeTimeResponse), align=36),
                    lambda pkt: pkt.message_type == OmciSynchronizeTimeResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciGetCurrentData), align=36),
                    lambda pkt: pkt.message_type == OmciGetCurrentData.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciGetCurrentDataResponse), align=36),
                    lambda pkt: pkt.message_type == OmciGetCurrentDataResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciStartSoftwareDownload), align=36),
                    lambda pkt: pkt.message_type == OmciStartSoftwareDownload.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciStartSoftwareDownloadResponse), align=36),
                    lambda pkt: pkt.message_type == OmciStartSoftwareDownloadResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciDownloadSection), align=36),
                    lambda pkt: pkt.message_type == OmciDownloadSection.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciDownloadSectionLast), align=36),
                    lambda pkt: pkt.message_type == OmciDownloadSectionLast.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciDownloadSectionResponse), align=36),
                    lambda pkt: pkt.message_type == OmciDownloadSectionResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciEndSoftwareDownload), align=36),
                    lambda pkt: pkt.message_type == OmciEndSoftwareDownload.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciEndSoftwareDownloadResponse), align=36),
                    lambda pkt: pkt.message_type == OmciEndSoftwareDownloadResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciActivateImage), align=36),
                    lambda pkt: pkt.message_type == OmciActivateImage.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciActivateImageResponse), align=36),
                    lambda pkt: pkt.message_type == OmciActivateImageResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciCommitImage), align=36),
                    lambda pkt: pkt.message_type == OmciCommitImage.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciCommitImageResponse), align=36),
                    lambda pkt: pkt.message_type == OmciCommitImageResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciTest), align=36),
                    lambda pkt: pkt.message_type == OmciTest.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciTestResponse), align=36),
                    lambda pkt: pkt.message_type == OmciTestResponse.message_id
                ),
                (
                    FixedLenField(PacketField("omci_message", None, OmciTestResult), align=36),
